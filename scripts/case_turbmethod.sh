...
case ${turbmethod} in
    ...
    "SMC-C01A")
        ...
        ${cmd_nmlchange} -f gotmturb.nml -e gen_m -v 0.5
        ${cmd_nmlchange} -f gotmturb.nml -e gen_n -v -1.0
        ${cmd_nmlchange} -f gotmturb.nml -e gen_p -v -1.0
        ${cmd_nmlchange} -f gotmturb.nml -e cpsi1 -v 0.555
        ${cmd_nmlchange} -f gotmturb.nml -e cpsi2 -v 0.833
        ${cmd_nmlchange} -f gotmturb.nml -e cpsi3minus -v -0.6
        ${cmd_nmlchange} -f gotmturb.nml -e cpsi3plus -v 1.0
				${cmd_nmlchange} -f gotmturb.nml -e e6 -v 0.15
        ${cmd_nmlchange} -f gotmturb.nml -e sig_kpsi -v 2.0
        ${cmd_nmlchange} -f gotmturb.nml -e sig_psi -v 2.0
        ${cmd_nmlchange} -f gotmmean.nml -e lagrangian_mixing -v .false.
        ${cmd_nmlchange} -f gotmmean.nml -e stokes_coriolis -v .false.
        ;;
    "SMC-C01A-lt")
        ${cmd_nmlchange} -f gotmturb.nml -e turb_method -v 3
        ${cmd_nmlchange} -f gotmturb.nml -e tke_method -v 5
        ${cmd_nmlchange} -f gotmturb.nml -e len_scale_method -v 12
        ${cmd_nmlchange} -f gotmturb.nml -e scnd_method -v 5
        ${cmd_nmlchange} -f gotmturb.nml -e scnd_coeff -v 7
        ${cmd_nmlchange} -f gotmturb.nml -e length_lim -v .false.
        ${cmd_nmlchange} -f gotmturb.nml -e compute_c3 -v .false.
        ${cmd_nmlchange} -f gotmturb.nml -e gen_m -v 0.5
        ${cmd_nmlchange} -f gotmturb.nml -e gen_n -v -1.0
    ...
    "SMCOP-lt-ql")
        ...
        ${cmd_nmlchange} -f gotmturb.nml -e length_lim -v .false.
        ${cmd_nmlchange} -f gotmturb.nml -e compute_c3 -v .false.
        ${cmd_nmlchange} -f gotmturb.nml -e gen_m -v 1.0
        ${cmd_nmlchange} -f gotmturb.nml -e gen_n -v 1.0
        ${cmd_nmlchange} -f gotmturb.nml -e gen_p -v 0.0
        ${cmd_nmlchange} -f gotmturb.nml -e cpsi1 -v 0.9
        ${cmd_nmlchange} -f gotmturb.nml -e cpsi2 -v 0.52
        ${cmd_nmlchange} -f gotmturb.nml -e cpsi3minus -v 2.5
        ${cmd_nmlchange} -f gotmturb.nml -e cpsi3plus -v 1.0
        ${cmd_nmlchange} -f gotmturb.nml -e sig_kpsi -v 1.96
        ${cmd_nmlchange} -f gotmturb.nml -e sig_psi -v 1.96
        ${cmd_nmlchange} -f gotmmean.nml -e lagrangian_mixing -v .false.
        ${cmd_nmlchange} -f gotmmean.nml -e stokes_coriolis -v .false.
        ;;
    "SMC")
    ...
    "SMC-KC04")
        ...
        ${cmd_nmlchange} -f gotmturb.nml -e e6 -v 4.0
        ${cmd_nmlchange} -f gotmturb.nml -e scnd_method -v 1
        ${cmd_nmlchange} -f gotmturb.nml -e scnd_coeff -v 3
        ${cmd_nmlchange} -f gotmturb.nml -e length_lim -v .true.
        ${cmd_nmlchange} -f gotmturb.nml -e compute_c3 -v .false.
    ...
    "SMCOP_1")
        ...
        ${cmd_nmlchange} -f gotmturb.nml -e e6 -v 6.0
        ${cmd_nmlchange} -f gotmturb.nml -e scnd_method -v 4
        ${cmd_nmlchange} -f gotmturb.nml -e scnd_coeff -v 1
        ${cmd_nmlchange} -f gotmturb.nml -e length_lim -v .false.
        ${cmd_nmlchange} -f gotmturb.nml -e compute_c3 -v .false.
        ${cmd_nmlchange} -f gotmmean.nml -e lagrangian_mixing -v .false.
        ${cmd_nmlchange} -f gotmmean.nml -e stokes_coriolis -v .true.
    ...
    "SMCOP_2")
        ...
        ${cmd_nmlchange} -f gotmturb.nml -e e6 -v 6.0
        ${cmd_nmlchange} -f gotmturb.nml -e scnd_method -v 4
        ${cmd_nmlchange} -f gotmturb.nml -e scnd_coeff -v 2
        ${cmd_nmlchange} -f gotmturb.nml -e length_lim -v .false.
        ${cmd_nmlchange} -f gotmturb.nml -e compute_c3 -v .false.
        ${cmd_nmlchange} -f gotmmean.nml -e lagrangian_mixing -v .false.
        ${cmd_nmlchange} -f gotmmean.nml -e stokes_coriolis -v .true.
    ...
    "SMCOP_4")
        ...
        ${cmd_nmlchange} -f gotmturb.nml -e e6 -v 6.0
        ${cmd_nmlchange} -f gotmturb.nml -e scnd_method -v 4
        ${cmd_nmlchange} -f gotmturb.nml -e scnd_coeff -v 4
        ${cmd_nmlchange} -f gotmturb.nml -e length_lim -v .false.
        ${cmd_nmlchange} -f gotmturb.nml -e compute_c3 -v .false.
        ${cmd_nmlchange} -f gotmmean.nml -e lagrangian_mixing -v .false.
        ${cmd_nmlchange} -f gotmmean.nml -e stokes_coriolis -v .true.
    ...
    "SMCOP_6")
        ...
        ${cmd_nmlchange} -f gotmturb.nml -e e6 -v 6.0
        ${cmd_nmlchange} -f gotmturb.nml -e scnd_method -v 4
        ${cmd_nmlchange} -f gotmturb.nml -e scnd_coeff -v 6
        ${cmd_nmlchange} -f gotmturb.nml -e length_lim -v .false.
        ${cmd_nmlchange} -f gotmturb.nml -e compute_c3 -v .false.
        ${cmd_nmlchange} -f gotmmean.nml -e lagrangian_mixing -v .false.
        ${cmd_nmlchange} -f gotmmean.nml -e stokes_coriolis -v .true.
